...
void main(void){
    ...
    int correct_wires_left = 2;

    while(1){
        if(PORTAbits.RA5 == 0 || PORTCbits.RC5 == 0 || PORTCbits.RC4 == 0 || PORTCbits.RC3 == 0 || PORTCbits.RC6 == 0 || PORTCbits.RC7 == 0){
            LATCbits.LATC2 = 1;
        }else{
            LATCbits.LATC2 = 0;
        }
